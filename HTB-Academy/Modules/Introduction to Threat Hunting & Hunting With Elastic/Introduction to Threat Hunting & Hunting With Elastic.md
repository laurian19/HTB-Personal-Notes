...
![[Introduction to Threat Hunting & Hunting With Elastic-1774995141004.webp]]

- `Threat`: A threat is a multifaceted concept, consisting of three fundamental factors, intent, capability, and opportunity.

![[Introduction to Threat Hunting & Hunting With Elastic-1774995161194.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1774995187431.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1774995231947.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775032719435.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775032758735.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775032767413.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035081234.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035088890.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035115479.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035129397.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035145331.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035159377.webp]]

**Note**: We can easily identify major sources of noise by looking at the most common values that Kibana has detected (click on a field as follows), and then apply a filter on the known noisy ones.

![[Introduction to Threat Hunting & Hunting With Elastic-1775035170605.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035180361.webp]]

![[Introduction to Threat Hunting & Hunting With Elastic-1775035184054.webp]]

Scrolling down the table of entries, we observe the following activities.

![[Introduction to Threat Hunting & Hunting With Elastic-1775035192709.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035202543.webp]]
...
**Note**: The time frame we specified previously should be removed, setting it to, say, 15 years again. The `dns.question.name` column should also be removed.

![[Introduction to Threat Hunting & Hunting With Elastic-1775035212605.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035227009.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035240651.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035249977.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035269393.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035276913.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035287582.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035295333.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035303423.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035310089.webp]]

The newly discovered IP also indicates that connections continued consistently over the following days.

![[Introduction to Threat Hunting & Hunting With Elastic-1775035322643.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035333112.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035344177.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035356082.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035364475.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775035382847.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775045964370.webp]]
...
And eliminate popular values of this field until we are left with less events.

At some point, we look for `share` and we find the following event:

![[Introduction to Threat Hunting & Hunting With Elastic-1775047635575.webp]]

We look online for some of the code in this block and find that it part of PowerView's `Invoke-ShareFinder.ps1` function. 
...
We check the information from the referenced link first:

![[Introduction to Threat Hunting & Hunting With Elastic-1775050803086.webp]]

Then, we use the following KQL query:

```
event.code:11 and file.name:R* and message:"C:\Users\Public*"
```

Where Sysmon Event ID 11 corresponds to file creation.

![[Introduction to Threat Hunting & Hunting With Elastic-1775049329012.webp]]

2. Enter your answer for Hunt 2.

**Answer**: LgvHsviAUVTsIN

We use the following KQL query:

```
event.code:12 AND message:"SOFTWARE\Microsoft\Windows\CurrentVersion\*"
```

based on the following 2 resources:

![[Introduction to Threat Hunting & Hunting With Elastic-1775050078872.webp]]

![[Introduction to Threat Hunting & Hunting With Elastic-1775050094111.webp]]

We find multiple hits, but the ones that get our attention are the following (the last 3 in chronological order from top to bottom):

![[Introduction to Threat Hunting & Hunting With Elastic-1775050183434.webp]]

Note that we ignore the entries related to legitimate software installations, such as Skype and Microsoft Windows Defender.

Alternatively, we could have looked at Sysmon Event ID 13, as shown below:

![[Introduction to Threat Hunting & Hunting With Elastic-1775050529324.webp]]
...
![[Introduction to Threat Hunting & Hunting With Elastic-1775050640482.webp]]

The fact that `default.exe` and `powershell.exe` set registry values for suspicious registry keys is already intriguing. 

3. Enter your answer for Hunt 3.

**Answer**: svc-sql1

We inspect the resource referenced:

![[Introduction to Threat Hunting & Hunting With Elastic-1775051139426.webp]]

![[Introduction to Threat Hunting & Hunting With Elastic-1775051155690.webp]]

However, we still filter for Event ID 4104 and use the following KQL query:
...
This is because:
- Event ID 4648, in comparison, is not a good primary hunt signal for Hunt 3 as PowerShell Remoting over WinRM often uses the current user’s Kerberos context, so there may be no separate “explicit credentials” moment to log as 4648 at all. And even when 4648 does appear, it is still ambiguous, because many benign actions can trigger it too. So 4648 is neither specific enough nor reliable enough to prove PowerShell Remoting lateral movement. 

Note that Event ID 4648 means “a logon was attempted using explicit credentials.”.

This is why we used Event ID 4104.

The result of the query has 7 hits, but only the first one interests us:

![[Introduction to Threat Hunting & Hunting With Elastic-1775080058084.webp]]
