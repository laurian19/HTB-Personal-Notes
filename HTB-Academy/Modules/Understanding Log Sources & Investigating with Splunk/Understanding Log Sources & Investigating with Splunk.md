...
- **Tags**: #Splunk #SPL #SharpHound #BOTS #TTP #DSync #LSASS #LSASS_Dump #Execute_Assembly #Unmanaged_PowerShell_Injection #githubusercontent #PsExec #MITTRE 
- **Description**: This module provides a comprehensive introduction to Splunk, focusing on its architecture and the creation of effective detection-related SPL (Search Processing Language) searches. We will learn to investigate with Splunk as a SIEM tool and develop TTP-driven and analytics-driven SPL searches for enhanced threat detection and response. Through hands-on exercises, we will learn to identify and understand the ingested data and available fields within Splunk. We will also gain practical experience in leveraging Splunk's powerful features for security monitoring and incident investigation.
- **Link to the module**: https://academy.hackthebox.com/app/module/218
...
![[Understanding Log Sources & Investigating with Splunk-1775128295192.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775128298826.webp]]
...
The `lookup` command enriches the data with external sources. Example:  Suppose the following CSV file called `malware_lookup.csv`.
...
![[Understanding Log Sources & Investigating with Splunk-1775128715860.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775128721924.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775128727100.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775128732332.webp]]
...
**Note**: You can apply each of the searches mentioned above successfully against the data within the Splunk instance of the target that you can spawn below. We highly recommend running and even modifying these searches to familiarize yourself with SPL (Search Processing Language) and its capabilities.
...
![[Understanding Log Sources & Investigating with Splunk-1775129109342.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775129129100.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775129138791.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775129173260.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775129194327.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775129198497.webp]]
...
We filter by the following Event ID:

![[Understanding Log Sources & Investigating with Splunk-1775933329296.webp]]

We used the following SPL query:
...
![[Understanding Log Sources & Investigating with Splunk-1775933424050.webp]]
...
This is the result we got:
![[Understanding Log Sources & Investigating with Splunk-1775933643524.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775936707909.webp]]

**Note**: We used the hint "range() can help you answer this question. Use the stats command to calculate the time range. Aggregate functions and Time functions from Splunk's documentation will help you."
...
![[Understanding Log Sources & Investigating with Splunk-1775936991926.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775937007741.webp]]

4. Add the application as follows to your search head.

![[Understanding Log Sources & Investigating with Splunk-1775937023615.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775937027298.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775937030797.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775937041408.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775937045632.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775937050634.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775937054196.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775937065466.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775937073833.webp]]

We can fix that by clicking on "Edit" (upper right hand corner of the screen) and editing the search.

![[Understanding Log Sources & Investigating with Splunk-1775937096647.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775937105004.webp]]

Results should now be generated successfully in the "Top Systems" section.

![[Understanding Log Sources & Investigating with Splunk-1775937122690.webp]]
...
The initial SPL query is:

```
`sysmon` process=net.exe (CommandLine="net  view") | stats count by Computer,CommandLine
```

The fixed SPL query is:

```
`sysmon` Image="*net.exe" CommandLine="*net  view*" | stats count by CommandLine
```

The result we got is:

![[Understanding Log Sources & Investigating with Splunk-1775945693293.webp]]
...
```
`sysmon` EventCode=3 Image="$imgsel$" protocol="$protosel$" dest_port="$portsel$" "$destinations$" | eval Destination=coalesce(dest_host,dest_ip) | stats count, values(Destination) AS "Destinations", values(dest_port) AS "Ports", values(protocol) AS "Protocols" by Image | fields Image Destinations Ports Protocols count
```
...
![[Understanding Log Sources & Investigating with Splunk-1775946312944.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979316040.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979338104.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979350193.webp]]

We can delve into the events by clicking the arrow on the left.

![[Understanding Log Sources & Investigating with Splunk-1775979360157.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979374538.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979386568.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979413723.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979438850.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979464791.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979480132.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979492987.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775979501123.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979513019.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979522806.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979531641.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979546292.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979560254.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979570692.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979579374.webp]]

We notice two intriguing GUIDs. A quick Google search can yield valuable insights. Let's look them up.

![[Understanding Log Sources & Investigating with Splunk-1775979585851.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775979588785.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775979596401.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979612557.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979625952.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979634491.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979667247.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979679587.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979694878.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979709956.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979724433.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979737482.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775979751668.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775988117250.webp]]

Our answer is based on this:

![[Understanding Log Sources & Investigating with Splunk-1775988142233.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775988633791.webp]]

![[Understanding Log Sources & Investigating with Splunk-1775988664431.webp]]
...
The SPL query we used first is: 
...
![[Understanding Log Sources & Investigating with Splunk-1775989227122.webp]]

We then used the following SPL query:
...
![[Understanding Log Sources & Investigating with Splunk-1775991325507.webp]]

This is a good indication that `rundll32.exe` has been used to execute code temporarily. 
...
We run the following SPL query:

```
index="main" EventCode=3 Image!="C:\\Users\\waldo\\AppData\\Local\\Microsoft\\Teams\\current\\Teams.exe" Image!="C:\\Users\\waldo\\AppData\\Local\\Temp\\*" Image!="*Microsoft*" Image!="*OneDrive*" Image!="*nslookup*" Image!="*svchost.exe*" Image!="*Update*"
| stats count by DestinationIp, Image
| sort - count
```

Note that we filter out multiple processes which perform legitimate network connections.

We get the following result.

![[Understanding Log Sources & Investigating with Splunk-1775992437628.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775992902511.webp]]
...
**Note**: Please be aware that the upcoming sections do not pertain to detection engineering. The emphasis in these sections is on comprehending the two distinct approaches for constructing searches, rather than the actual process of analyzing an attack, identifying relevant log sources, and formulating searches. Furthermore, the provided searches are not finely tuned. As previously mentioned, fine-tuning necessitates a deep comprehension of the environment and its normal activity.
...
![[Understanding Log Sources & Investigating with Splunk-1775993342598.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775993360492.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775993421419.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775993435366.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775993449902.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775993473751.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775993494908.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775993505158.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775993527196.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775993551972.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775993575839.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775993596806.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775995976844.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775996003442.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775996038629.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775996060409.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775996111288.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775996141133.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775996153796.webp]]
...
**Note**: By establishing a profile of "normal" behavior and utilizing a statistical model to identify deviations from a baseline, we could have detected the compromise of our environment more rapidly, especially with a thorough understanding of attacker tactics, techniques, and procedures (TTPs). However, it is important to acknowledge that relying solely on this approach when crafting queries is inadequate.
...
![[Understanding Log Sources & Investigating with Splunk-1775997777863.webp]]
...
![[Understanding Log Sources & Investigating with Splunk-1775998002048.webp]]
...
The reasoning is that `randomfile.exe` is the process that created a remote thread in `rundll32.exe`, but the latter is the one that actually started the infection.
