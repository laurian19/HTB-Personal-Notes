...
![[Security Monitoring & SIEM Fundamentals-1774806067703.webp|697|700x382]]
*Elastic Stack diagram showing components: Solutions (Application Search, Site Search, Enterprise Search, Logging, Future), Visualize (Kibana), Store Search & Analyze (Elasticsearch), Ingest (Beats, Logstash), Deployment (SaaS: Elastic Cloud, Self Managed: Elastic Cloud Enterprise, Standalone).*
...
![[Security Monitoring & SIEM Fundamentals-1774806219344.webp]]
*Beats collect data from sources like Filebeat and Metricbeat, send to Logstash or Messaging Queue (Kafka, Redis), then to Elasticsearch for processing (Master, Ingest, Data nodes), and finally to Kibana for visualization.*
...
![[Security Monitoring & SIEM Fundamentals-1774806302694.webp]]
*Beats collect data (Filebeat, Metricbeat), send to Logstash with persistent queues, then to Elasticsearch (Master, Data, ML Nodes), and finally to Kibana for visualization.*

`Beats` -> `Elasticsearch` -> `Kibana`

![[Security Monitoring & SIEM Fundamentals-1774806328034.webp]]
*Beats collect data (Filebeat, Metricbeat), send to Elasticsearch with uniform nodes, and finally to Kibana for visualization.*
...
![[Security Monitoring & SIEM Fundamentals-1774807213714.webp]]
*Elastic interface showing a side navigation toggle, search bar, histogram, and document table with network event logs. Includes time picker and index pattern selection.*
...
![[Security Monitoring & SIEM Fundamentals-1774806491398.webp]]
*Elastic interface displaying search results for '4625' with a histogram, document table, and filter options.*
...
![[Security Monitoring & SIEM Fundamentals-1774806529464.webp]]
*Elastic interface showing search results for '0xC0000072' with a histogram and document table displaying event data.*
...
- `Better Visualizations`: Consistent field naming conventions improve the efficac---y of visualizations in Kibana. As all data sources adhere to the same schema, creating dashboards and visualizations becomes easier and more intuitive. This can help in spotting trends, identifying anomalies, and visualizing security incidents.
...
![[Security Monitoring & SIEM Fundamentals-1774808885701.webp]]
*MITRE ATT&CK matrix showing tactics like Reconnaissance, Execution, and Exfiltration with associated techniques.*
...
![[Security Monitoring & SIEM Fundamentals-1774809488201.webp]]
*Diagram of Usecase Lifecycle with stages: Requirements, Data Points, Log Validation, Design, Implementation, Documentation, Onboarding, Testing, Fine Tuning.*
...
![[Security Monitoring & SIEM Fundamentals-1774809553345.webp]]
*Dashboard showing MSBuild started by Office apps, with high severity and risk score 73. Includes MITRE ATT&CK tactics and custom query details.*
...
![[Security Monitoring & SIEM Fundamentals-1774809588380.webp]]
*Dashboard showing MSBuild making network connections with medium severity and risk score 47. Includes MITRE ATT&CK execution details and custom query information.*
...
![[Security Monitoring & SIEM Fundamentals-1774815080448.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815209205.webp]]

Now, to initiate the creation of our first visualization, we simply have to click on the "Create visualization" button.

![[Security Monitoring & SIEM Fundamentals-1774815222785.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815258192.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815268160.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815281148.webp]]

4. "Why `user.name.keyword` and not `user.name`?", you may ask. We should use the `.keyword` field when it comes to aggregations. Please refer to this [stackoverflow question](https://stackoverflow.com/questions/48869795/difference-between-a-field-and-the-field-keyword) for a more elaborate answer.
5. Lastly, this drop-down menu enables us to select the type of visualization we want to create. The default option displayed in the earlier image is "Bar vertical stacked". If we click on that button, it will reveal additional available options (image redacted as not all options fit on the screen). From this expanded list, we can choose the desired visualization type that best suits our requirements and data presentation needs.

![[Security Monitoring & SIEM Fundamentals-1774815295027.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815308645.webp]]

Let's configure the "Rows" settings as follows.

![[Security Monitoring & SIEM Fundamentals-1774815315655.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815329252.webp]]

In the "Metrics" window, let's select "count" as the desired metric.

![[Security Monitoring & SIEM Fundamentals-1774815336917.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815348666.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815360729.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815369124.webp]]

Let's not forget to save the dashboard as well. We can do so by simply clicking on the "Save" button.

![[Security Monitoring & SIEM Fundamentals-1774815376600.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815389157.webp]]

Let's now click on the "gear" button at the upper-right corner of our visualization, and then click on "Edit lens".

![[Security Monitoring & SIEM Fundamentals-1774815396526.webp]]

"Top values of user.name.keyword" should be changed as follows.

![[Security Monitoring & SIEM Fundamentals-1774815408454.webp]]

![[Security Monitoring & SIEM Fundamentals-1774815411786.webp]]

"Top values of host.hostname.keyword" should be changed as follows.

![[Security Monitoring & SIEM Fundamentals-1774815419323.webp]]

The "Logon Type" can be added as follows (we will use the `winlog.logon.type.keyword` field).

![[Security Monitoring & SIEM Fundamentals-1774815426797.webp]]

![[Security Monitoring & SIEM Fundamentals-1774815430815.webp]]

"Count of records" should be changed as follows.

![[Security Monitoring & SIEM Fundamentals-1774815438285.webp]]

We can introduce result sorting as follows.

![[Security Monitoring & SIEM Fundamentals-1774815445449.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815454566.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774815470632.webp]]

This is our visualization after all the refinements we performed.

![[Security Monitoring & SIEM Fundamentals-1774815482611.webp]]

Finally, let's give our visualization a title by clicking on "No Title".

![[Security Monitoring & SIEM Fundamentals-1774815491492.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774816813296.webp]]

Now, to initiate the creation of our first visualization, we simply have to click on the "Create visualization" button.

Upon initiating the creation of our first visualization, the following new window will appear with various options and settings.

![[Security Monitoring & SIEM Fundamentals-1774816821486.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774816831290.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774816842800.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774816855866.webp]]

For this visualization, let's select the "Table" option. After selecting the "Table", we can proceed to click on the "Rows" option. This will allow us to choose the specific data elements that we want to include in the table view.

![[Security Monitoring & SIEM Fundamentals-1774816863013.webp]]

Let's configure the "Rows" settings as follows.

![[Security Monitoring & SIEM Fundamentals-1774816872219.webp]]

Moving forward, let's close the "Rows" window and proceed to enter the "Metrics" configuration.

![[Security Monitoring & SIEM Fundamentals-1774816880007.webp]]

In the "Metrics" window, let's select "count" as the desired metric.

![[Security Monitoring & SIEM Fundamentals-1774816886117.webp]]

One final addition to the table is to include another "Rows" setting to show the machine where the failed logon attempt occurred. To do this, we will select the `host.hostname.keyword` field, which represents the computer reporting the failed logon attempt. This will allow us to display the hostname or machine name alongside the count of failed logon attempts, as shown in the image.

![[Security Monitoring & SIEM Fundamentals-1774816893074.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774817595809.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774817604991.webp]]

![[Security Monitoring & SIEM Fundamentals-1774817609476.webp]]

2. This field indicates the data set (index) that we are going to use. It is common for data from various infrastructure sources to be separated into different indices, such as network, Windows, Linux, etc. In this particular example, we will specify `windows*` in the "Index pattern".
3. This search bar provides us with the ability to double-check the existence of a specific field within our data set, serving as another way to ensure that we are looking at the correct data. We are interested in the `user.name.keyword` field. We can use the search bar to quickly perform a search and verify if this field is present and discovered within our selected data set. This allows us to confirm that we are accessing the desired field and working with accurate data.

![[Security Monitoring & SIEM Fundamentals-1774817621413.webp]]

4. Lastly, this drop-down menu enables us to select the type of visualization we want to create. The default option displayed in the earlier image is "Bar vertical stacked". If we click on that button, it will reveal additional available options (image redacted as not all options fit on the screen). From this expanded list, we can choose the desired visualization type that best suits our requirements and data presentation needs.

![[Security Monitoring & SIEM Fundamentals-1774817639163.webp]]

For this visualization, let's select the "Table" option. After selecting the "Table", we can proceed to click on the "Rows" option. This will allow us to choose the specific data elements that we want to include in the table view.

![[Security Monitoring & SIEM Fundamentals-1774817647386.webp]]

Let's configure the "Rows" settings as follows.

![[Security Monitoring & SIEM Fundamentals-1774817654126.webp]]

Moving forward, let's close the "Rows" window and proceed to enter the "Metrics" configuration.

![[Security Monitoring & SIEM Fundamentals-1774817661811.webp]]

In the "Metrics" window, let's select "count" as the desired metric.

![[Security Monitoring & SIEM Fundamentals-1774817668580.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774817679485.webp]]

![[Security Monitoring & SIEM Fundamentals-1774817683710.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774817704831.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774818145355.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774818178314.webp]]

Moving forward, let's close the "Rows" window and proceed to enter the "Metrics" configuration.

In the "Metrics" window, let's select "count" as the desired metric.

![[Security Monitoring & SIEM Fundamentals-1774818197760.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774818208642.webp]]
...
![[Security Monitoring & SIEM Fundamentals-1774818216035.webp]]

![[Security Monitoring & SIEM Fundamentals-1774818224405.webp]]

![[Security Monitoring & SIEM Fundamentals-1774818230652.webp]]
